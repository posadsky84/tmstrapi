...
export interface ApiBadgeBadge extends Schema.CollectionType {
  ...
  attributes: {
    ...
    race: Attribute.Relation<'api::badge.badge', 'oneToOne', 'api::race.race'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::badge.badge',
...
export interface ApiDistanceDistance extends Schema.CollectionType {
...
export interface ApiHotBlockHotBlock extends Schema.SingleType {
  collectionName: 'hot_blocks';
  info: {
    singularName: 'hot-block';
    pluralName: 'hot-blocks';
    displayName: 'hotBlock';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    hotText: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::hot-block.hot-block',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMainPageMainPage extends Schema.SingleType {
  ...
  info: {
    ...
    displayName: '\u0413\u043B\u0430\u0432\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430 (\u043F\u043B\u0438\u0442\u043A\u0430)';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    tmBasicInfo: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    runner: Attribute.Relation<
      ...
      'api::runner.runner'
    >;
    dns: Attribute.Boolean;
    dnf: Attribute.Boolean;
    child: Attribute.Boolean;
...
export interface ApiRaceRace extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    ddate: Attribute.Date;
    magnet: Attribute.Media;
    sname: Attribute.String;
    ...
    >;
    cardPicture: Attribute.Media;
    rulesLink: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
